                    ...
                    <template>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                            ...
                            v-html="item.content"
                        ></v-list-item-subtitle>
                        <a v-if="countContentLength(item.content).length  > 300 || countLine(item.content)"
                           class="caption"
                           @click="updateShowMore(item.isShowMore, item)">{{
...
export default Vue.extend({
  ...
  methods: {
    countLine(content) {
      return content.split('br').length > 4;
    },
    countContentLength(content) {
